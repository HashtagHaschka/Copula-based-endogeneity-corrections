...
# Haschka (2024) using the least-squares-based correction function 
# approach.
#
...
CopRegIMA1 <- CopRegIMA(formula = logmove ~ price4 | price1 + price2 + price3 + price5 + price6 + price7 + price8 + price9 + price10,
                     data = dat1_Tropicana, cdf = "ecdf")
CopRegIMA1[[1]]
hist(CopRegIMA1[[2]])


CopRegIMA2 <- CopRegIMA(formula = logmove ~ price4 + price1 + price2 + price3 + price5 + price6 + price7 + price8 + price9 + price10,
                     data = dat1_Tropicana, cdf = "ecdf")
CopRegIMA2[[1]]
hist(CopRegIMA2[[2]])


CopRegIMA3 <- CopRegIMA(formula = logmove ~ price4 + price1 + price2 + price3 + price5 + price6 + price7 + price8 + price9 + price10 | feat + as.factor(deal),
                     data = dat1_Tropicana, cdf = "ecdf")
CopRegIMA3[[1]]
hist(CopRegIMA3[[2]])


CopRegIMA4 <- CopRegIMA(formula = logmove ~ price4 + price1 + price2 + price3 + price5 + price6 + price7 + price8 + price9 + price10 | feat + as.factor(deal) + as.factor(store),
                     data = dat1_Tropicana, cdf = "ecdf")
CopRegIMA4[[1]]
hist(CopRegIMA4[[2]])
